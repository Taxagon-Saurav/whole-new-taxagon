  ...
  return (
    <PageTransition>
      ...
      <section className="container-shell overflow-hidden rounded-full border border-slate-200 bg-white/80 py-4 shadow-sm" aria-label="Trusted services">
        <div className="marquee-track flex w-[200%] gap-8 whitespace-nowrap text-sm font-bold uppercase tracking-[0.18em] text-slate-500">
      ...
      <section className="container-shell grid gap-10 py-20 lg:grid-cols-2 lg:items-center">
        <Reveal><div className="rounded-[2.5rem] bg-slate-950 p-6 text-white shadow-2xl shadow-slate-950/20"><div className="rounded-[2rem] bg-white p-6 text-slate-950"><p className="text-sm font-bold uppercase tracking-[0.2em] text-[#1C41F7]">A new accounting experience</p><h2 className="mt-4 text-4xl font-bold tracking-[-0.055em]">Use your time more efficiently and hit your goals.</h2><div className="mt-8 grid gap-3"><span className="rounded-2xl bg-blue-50 p-4 font-bold">✓ Full suite of accounting services</span><span className="rounded-2xl bg-blue-50 p-4 font-bold">✓ Quick responses and fewer missed deadlines</span><span className="rounded-2xl bg-blue-50 p-4 font-bold">✓ Scalable support as your needs evolve</span></div></div></div></Reveal>
      ...
      <section className="container-shell py-10"><Reveal className="grid gap-8 rounded-[2.5rem] bg-[#1C41F7] p-8 text-white shadow-2xl shadow-[#1C41F7]/25 md:grid-cols-[1fr_auto] md:items-center"><div><p className="text-sm font-bold uppercase tracking-[0.2em] text-blue-100">Community</p><h2 className="mt-3 text-3xl font-bold tracking-[-0.05em] sm:text-5xl">Join our WhatsApp community and save money on taxes.</h2></div><ButtonLink href={links.whatsapp} variant="secondary">Join Community</ButtonLink></Reveal></section>
